...
function setSession(res, token) {
  res.setHeader('Set-Cookie', `gx_session=${encodeURIComponent(seal(token))}; Path=/; Domain=.goonfx.com; HttpOnly; Secure; SameSite=None; Max-Age=3600`);
}
function clearSession(res) { res.setHeader('Set-Cookie','gx_session=; Path=/; Domain=.goonfx.com; HttpOnly; Secure; SameSite=None; Max-Age=0'); }
